...
| [ADR-0007](ADR-0007-compression-codec.md) | Adopt Zstandard as the default compression codec | Accepted |
| [ADR-0008](ADR-0008-android-runtime-approach.md) | Adopt an AOSP-based container runtime for Android compatibility | Accepted |
| [ADR-0009](ADR-0009-ipc-rate-limiting.md) | Per-container token-bucket rate limiting for IPC | Accepted |
...
| [ADR-0013](ADR-0013-scheduler-algorithm.md) | Adopt an EEVDF-derived scheduler with a real-time priority class | Accepted |
...
| [ADR-0023](ADR-0023-nyvault-key-manager.md) | NyVault key manager — envelope encryption with Rust-held key custody | Accepted |
