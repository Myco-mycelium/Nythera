...
6. [~] Architecture diagrams — **8 of 11 landed**: boot sequence, NyHAL architecture, container lifecycle, capability grant flow, package mount lifecycle, plus object graph, capability graph, scheduler structure, memory manager, game package layering, and update pipeline (the 2026-09-23 batch) under [`docs/diagrams/`](../diagrams/README.md); AI subsystem and identity subsystem diagrams remain — both unblocked now that their governing NPS documents exist (NPS-015, NPS-029)
