...
no enumeration, mutations are audit-chained) — remaining named
increments: §3.2's physical IPC transport (daemon integration
exposing the service across the process boundary), §5.3 bounds. The propose-
