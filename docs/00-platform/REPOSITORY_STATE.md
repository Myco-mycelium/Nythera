...
exposes it)
— remaining named
increments: §5.3 bounds (frozen by design), the daemon's production
process model (deployment, not surface). The propose-
