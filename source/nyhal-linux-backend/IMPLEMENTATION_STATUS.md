...
| IPC Semantics | `ipc/core.py`, `ipc/transport.py` | ✓ Implemented | send/receive/call/notify primitives, receive-side capability check, token-bucket rate limiting, **Unix-domain datagram transport** (SCM_CREDENTIALS sender authentication, wire-codec framing) |
