...
- [ ] veth/bridge outbound connectivity for `network=True` containers (the netns is currently a loopback-only isolation boundary)
...
3. ✓ Network namespace support — landed 2026-08-14 (`network=True` config flag; loopback-only netns; veth/bridge connectivity deferred)
